...
$access_token = '444f5fb36c62d56b16b1db84bf512dc515fc8486eb82d051703d2242cfb13c67646202ba6b0facbf07bf9';
...
$last_subscribe_photo_pixel_x = 1063;

// Координаты аватарки по оси Y
$last_subscribe_photo_pixel_y = 22;

// Координаты имени и фамилии по оси Х
$last_subscribe_text_pixel_x = 1210;

// Координаты имени и фамилии по оси Y
$last_subscribe_text_pixel_y = 75;
...
// Координаты аватарки по оси Х
$top_comments_photo_pixel_x = 1063;

// Координаты аватарки по оси Y
$top_comments_photo_pixel_y = 213;

// Координаты имени и фамилии по оси Х
$top_comments_text_pixel_x = 1210;

// Координаты имени и фамилии по оси Y
$top_comments_text_pixel_y = 275;
...
// Координаты аватарки по оси Х
$top_like_photo_pixel_x = 1063;

// Координаты аватарки по оси Y
$top_like_photo_pixel_y = 119;

// Координаты имени и фамилии по оси Х
$top_like_text_pixel_x = 1210;

// Координаты имени и фамилии по оси Y
$top_like_text_pixel_y = 175;
...
$output_header = BASEPATH.'header/output.jpg';
// Версия API
$api_version = "5.63";
// Включаем сессию
session_start();
