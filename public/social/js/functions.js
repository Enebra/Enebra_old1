...
/*    if($("#potrebnost_link").is('active')) {
      alert('ljhlj') 
    $(".personal_data").find(".potr_show").addClass('active');
  }  
  
  
$('.personal_data .nav li').click(function(){});*/




/*$('#votescarousel').on('slid.bs.carousel', checkitem);
function checkitem()  {
  var $this = $('#votescarousel');
  if($('.carousel-inner .item:first').hasClass('active')) {
    $this.children('.custom_carousel_control.left').hide();
    $this.children('.custom_carousel_control.right').show();
  } else if($('.carousel-inner .item:last').hasClass('active')) {
    $this.children('.custom_carousel_control.left').show();
    $this.children('.custom_carousel_control.right').show();
  } else {
    $this.children('.custom_carousel_control').show();
