                     ...
                     <div class="col-xs-12">
                      ...
                      <div class="nav_bl">  
                       <ul  class="nav nav-pills uspage_nav">
        			     <li><a class="active" href="/social/user-chron.php">Хроника</a></li>
                              ...
                              <div class="tab-pane" id="innovcoauth"> 
                                <div class="chron-tab-top col-xs-12 no-pad">
                                  ...
                                  <div class="col-xs-12 no-pad chrblock">
                                    ...
                                    <div class="img-wrap user_wrap_image"><img src="/social/img/fam.png"/><div class="chron_user_wr_name">Рустем Аблаев</div></div>
                                    </div>
