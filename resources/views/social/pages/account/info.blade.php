    ...
    <div class="col-xs-12">
        ...
        <div class="nav_bl">
            <ul class="nav nav-pills uspage_nav">
                <li><a href="/social/user-chron.php">{{Lang::get('account_nav.chron')}}</a></li>
                <li><a class="active" href="/social/user.php">{{Lang::get('account_nav.info')}}</a></li>
                <li><a href="/social/user-balance.php">{{Lang::get('account_nav.balance')}}</a></li>
                <li><a href="/social/user-lenta.php">{{Lang::get('account_nav.feed_setting')}}</a></li>
                <li class="create">
                    <div>{{Lang::get('account_nav.create')}}</div>
                    <a href="/social/user-create-innovat.php">{{Lang::get('account_nav.innovation')}}</a>
                    <a href="/social/user-create-inform.php">{{Lang::get('account_nav.information')}}</a>
                </li>
                <li><a href="/social/user-blockchain.php">{{Lang::get('account_nav.blockchain')}}</a></li>
            </ul>
        </div>
